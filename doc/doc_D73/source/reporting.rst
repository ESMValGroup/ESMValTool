...
The tags element in the DIAGNOSTICS section can be used to differentiate between the results of the diagnostics. Specifically, alternative variable names or similary should be used here.
...
Beyond these user introduced tags, the ESMValTool will ad the namelist's name to the global tag list and autogenerated names (e.g. Auto_Diag_001) to the diagnostics tag list.
