...
^^^^^^^^^^
   ...
   recipe_consecdrydays                Consecutive dry days
   recipe_crem                         Cloud Regime Error Metric (CREM)
   recipe_diurnal_temperature_index    Diurnal temperature range
   recipe_extreme_events               Extreme Events Indices (ETCCDI)
   recipe_heatwaves_coldwaves          Heat wave and cold wave duration
   recipe_hyint                        Hydroclimatic intensity and extremes (HyInt)
   recipe_modes_of_variability         Modes of variability
   recipe_quantilebias                 Precipitation quantile bias
   recipe_spei                         Standardized Precipitation-Evapotranspiration Index (SPEI)
   recipe_autoassess_stratosphere      Stratosphere - Autoassess diagnostics
   recipe_zmnam                        Stratosphere-troposphere coupling and annular modes indices (ZMNAM)
   recipe_thermodyn_diagtool           Thermodynamics of the Climate System - The Diagnostic Tool TheDiaTo v1.0
   recipe_validation                   Zonal and Meridional Means
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   ...
   recipe_smpi              Single Model Perfomance Index (SMPI)
...
^^^^^
   ...
   recipe_rainfarm                     RainFARM stochastic downscaling
   recipe_shapeselect                  Shapeselect
   recipe_toymodel                     Toymodel
