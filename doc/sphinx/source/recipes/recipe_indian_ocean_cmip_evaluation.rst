.. _recipes_indian_ocean_cmip_evaluation:

Indian Ocean CMIP Evaluation
============================
...
* recipe_indian_ocean_cmip_evaluation.yml

Diagnostics are stored in esmvaltool/diag_scripts/indian_ocean/
