...
#. ESMValCore feature freeze, testing, and release candidates
   ...
   - Activate the release candidate channel in the ``environment.yml`` of ESMValTool and adjust the pin on ESMValCore after each release candidate (e.g. ``esmvalcore==2.8.0rc1``).
