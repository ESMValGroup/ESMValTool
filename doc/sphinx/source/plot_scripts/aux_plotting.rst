...
.. function::  copy_VarAtt_sel(var1, var2, sel: string)
   ...
   :param  string sel: string (or list of strings) that specify the starting letters of the attributes to copy
...
.. function:: get_wks(wks_in, diag_script[1]: string, add_specs[1]: string)
   ...
   :param  string add_specs: own specifications to be added to file name, i.e. variable name, etc. - needed for function get_outfile_name
