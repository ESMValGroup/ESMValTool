...
class AlbedoDiagnostic(BasicDiagnostics):
    ...
    def _load_model_data(self):
        ...
        newdir=(self._work_dir if self._work_dir[-1]==os.sep else self._work_dir +os.sep) + "AUX_Files_alb_QA4ECV"
    ...
    def _load_observation_data(self):
        ...
        if self._project_info['RUNTIME']['currDiag'].get_variables()[0] == "alb":
