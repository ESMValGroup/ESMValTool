...
obs=obs2
period=ANN
metrics=~/ESMValTool-private/work/AutoAssess_radiation_rms_summary/$region
ometrics=~/ESMValTool-private/plot_scripts/python/AutoAssess_radiation_summary/$area
outdir=~/ESMValTool-private/work/AutoAssess_radiation_rms_summary

plot_norm_ac=~/ESMValTool-private/plot_scripts/python/AutoAssess_radiation_summary/plot_norm_ac_ideal.py
