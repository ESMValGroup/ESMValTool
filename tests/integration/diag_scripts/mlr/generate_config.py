...
CFG = {
    ...
    "predict_kwargs": [None, None, {"return_var": True}],
...
if __name__ == "__main__":
    ...
    for idx_cfg in range(N_CFG):
        ...
        logger_calls = []
        with mock.patch(
            "esmvaltool.diag_scripts.mlr.logger", autospec=True
        ) as mlr_logger:
            with mock.patch(
                "esmvaltool.diag_scripts.mlr.models.logger", autospec=True
            ) as models_logger:
                try:
