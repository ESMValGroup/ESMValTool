"""
Test script for "NCAR's Climate Variability Diagnostics Package (CVDP)"
"""
...
class TestDiagnostic(unittest.TestCase):
    ...
    def test_diagnostic(self):
        ...
        T = MyDiagnosticTest()
        T.run_nml()
        T.run_tests(execute=False, graphics=None, checksum_files=None, files='all')
