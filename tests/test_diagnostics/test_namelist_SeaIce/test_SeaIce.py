...
class SeaIceTest(ESMValToolTest):
    ...
    def __init__(self, **kwargs):
        xmlfile = os.path.dirname(os.path.realpath(__file__)) + os.sep + "namelist_SeaIce.xml"  # the realpath ensures that the file is also foudn wehn nosetests runs from an upper directory
        super(SeaIceTest, self).__init__(nml=xmlfile, **kwargs)
