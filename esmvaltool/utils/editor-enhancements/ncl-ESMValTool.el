...
;********************************************
; Updated: Wed Mar 18 13:46:13 MDT 2015
;
; Extended to include ESMValTool functions by M. Righi, DLR Germany
;
; Revision 0.34
...
; HOW TO USE
;********************************************
; Add and properly modify the following (without ;# comments) in your .emacs or 
; .xemacs/custom.el, and replace $ESMValPATH with your local ESMValTool path.
...
;#     (autoload 'ncl-mode "$ESMValPATH/util/ncl-ESMValTool.el")  
...
; See http://raebear.net/comp/emacscolors.html for more colors
...
(defvar ncl-font-lock-keywords
   '(
    ...
    ;; skewt functions
    ("\\<\\(skewT_BackGround\\|skewT_PlotData\\|skewT_BackGround\\|\\)\\>" 1 font-lock-function-name-face)

    ;; user_contributed functions
    ("\\<\\(calendar_decode2\\|cd_string\\|kf_filter\\|run_cor\\|time_axis_labels\\|ut_string\\|User_contributed\\|\\)\\>" 1 font-lock-function-name-face)
