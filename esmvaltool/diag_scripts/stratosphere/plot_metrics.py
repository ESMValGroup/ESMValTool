...
from esmvaltool.diag_scripts.stratosphere.calculate_metrics import (
    plot_nac,
    read_model_metrics,
    read_obs_metrics,
)
...
def main():
    ...
    file_exp = os.path.join(os.path.dirname(os.path.dirname(cfg['plot_dir'])),
                            cfg['diag_tag'], cfg['diag_name'], vsloc,
                            cfg['area'], exp_model, 'metrics.csv')
    file_ref = os.path.join(os.path.dirname(os.path.dirname(cfg['plot_dir'])),
                            cfg['diag_tag'], cfg['diag_name'], vsloc,
                            cfg['area'], control_model, 'metrics.csv')
    ...
    # Produce plot
    plot_nac(control_model, [exp_model],
             ref,
             tests,
             metrics=None,
             var=None,
