...
def select_by_variable_name(cubes, variable_name):
    ...
    :param string variable_name: CF-name or model-section-item STASH code, e.g.
        'm01s30i404'
...
def seasonal_mean(mycube):
    ...
    Chunks time in 3-month periods and computes means over them; Returns
    a cube.
    """
...
def annual_mean(mycube):
    ...
    Chunks time in 365-day periods and computes means over them; Returns
    a cube.
    """
