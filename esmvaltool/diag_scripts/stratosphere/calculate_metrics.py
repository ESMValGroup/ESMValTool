"""Plot stratosphere standard metrics.
...
def merge_obs_acc(obs, acc):
    ...
    :param dict obs: Dictionary of observational uncertainties
    :param dict acc: Dictionary of acceptable ranges
...
def plot_nac(cref,
    ...
    # Add plot legend
    legend = ax.legend(FAKELINES[0:len(ctests)],
                       ctests,
                       bbox_to_anchor=(1, 1),
                       loc=2,
                       numpoints=1,
