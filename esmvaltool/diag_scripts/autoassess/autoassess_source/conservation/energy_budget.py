...
def atmos_energy_budget(run):
    ...
    try:
        ...
        plt.plot(x, ch_en.data, linewidth=2, color='black',
                 label='E(end)-E(start)')
        plt.plot(x, diab_heat.data, linewidth=2, color='red',
                 label='E added to atmos from fluxes')
        plt.plot(x, ch_ke.data, linewidth=2, color='blue',
                 label='Change in KE')
        plt.plot(x, ch_cvt.data, linewidth=2, color='green',
                 label='Change in cvT')
        plt.plot(x, ch_gr.data, linewidth=2, color='purple',
                 label='Change in gr')
