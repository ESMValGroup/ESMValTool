...
idx_df <- data.frame(
  ...
  name = c(
    ...
    "Annual Diurnal Temperature Range (DTR)",
    "Frost Days (FD)",
    "Growing Season Length (GSL)",
    "Icing Days (ID)",
    "Annual Total Wet-Day Precipitation (PRCPTOT)",
    "Heavy Precipitation Days (R10)",
    "Precipitation Days (R1)",
    ...
    "Summer Days (SD)",
    "Monthly Cold Nights (TN10p)",
    "Annual Cold Nights (TN10p)",
    "Monthly Warm Nights (TN90p)",
    "Annual Warm Nights (TN90p)",
    "Monthly Minimum Tmin (TNn)",
    "Annual Minimum Tmin (TNn)",
    "Monthly Maximum Tmin (TNx)",
    "Annual Maximum Tmin (TNx)",
    "Tropical Nights (TR)",
    "Monthly Cool Days (TX10p)",
    "Annual Cool Days (TX10p)",
    "Monthly Warm Days (TX90p)",
    "Annual Warm Days (TX90p)",
    "Monthly Minimum Tmax (TXn)",
    "Annual Minimum Tmax (TXn)",
    "Monthly Maximum Tmax (TXn)",
    "Annual Maximum Tmax (TXn)",
