...
# (use x for none)
    ...
    if ann_warming!=0:
      ann_warming.append(calc_diag(tas_cb,1)) #Calculate ann warming.
    if gmst_comp_warming!=0:
      gmst_comp_warming.append(calc_diag(tas_cb,1)) #Calculate warming in globally-complete blended data.
