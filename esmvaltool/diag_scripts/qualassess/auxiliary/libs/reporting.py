...
def do_full_report(full_report, report_title, work_dir,
                   signature="SIG", ecv="ECV", dataset="DATASET",
                   latex_opts=False):
    """
    - report_data  a dictionary of a list of plot file names  (.png, ...)
                    including *full path*
    ...
    # search for text and plots instances in report_data
    for rd in full_report:
        
        report_data = full_report[rd]
        outfile.write(rd + "\n")
        outfile.write("=" * len(rd) + "\n\n")
