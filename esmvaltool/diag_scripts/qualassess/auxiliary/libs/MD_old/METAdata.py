...
class METAdata(object):
    ...
    def set_dict(self, dictionary):
        ...
        if "DataIDs" in list(self.__data_dict__['ESMValTool'].keys()):
    ...
    def __write_meta__(self):
        ...
        if len(list(self.__data_dict__.keys())) == 1:
        ...
        elif len(list(self.__data_dict__.keys())) == 0:
    ...
    def __read_meta__(self):
        ...
        image = Image.open(self.__modfile__)
        info = image.info
        if self.__exif_maintag__ in list(info.keys()):
            ...
            for f in file_list:
                if os.path.isfile(f):
                    try:
                        ...
                        ti = "tracking_id"
                        if ti in list(DataInfo.__dict__.keys()):
