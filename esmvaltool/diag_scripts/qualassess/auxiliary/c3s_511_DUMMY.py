...
class DUMMY_Diagnostic(Basic_Diagnostic):
	...
	#takes the first slice of a 3D cube
        ...
        # define filename
        filename = self.__plot_dir__ + os.sep + self.__basic_filename__ + "_mydiag" + "." + self.__output_type__
        ...
        ESMValMD("meta",
                 ...
                 # caption below EDIT!
                 str("mydiag" + ' values of ' + self.__varname__ + ' for the data set "' + "_".join(self.__dataset_id__) + '" (' + self.__time_period__ + ')'),
                 # identifier EDIT!
