...
# hailstorms.R
#
# Author: Nicola Cortesi (UniTo, Italy)
#       : Enrico Arnone (UniTo, Italy)
#
# #############################################################################
# Description
#    Code to estimate hailstorm probability with ERA5 and/or CMIP6 models
#
# Modification history
#    20251124-cortesi_nicola:        creation
#    
# #############################################################################
