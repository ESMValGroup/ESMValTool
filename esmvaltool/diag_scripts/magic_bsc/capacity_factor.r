...
#---------------------------
  filepng <- paste0(plot_dir, "/", "capacity_factor_", model_names[i], "_",
                    start_year, "-", end_year, ".png")
  title <- paste0(seasons, " CF from ", model_names[i],
                  " (", start_year, "-", end_year, ")")
  ...
  filencdf <- paste0(work_dir, "/", "capacity_factor_", model_names[i],  "_",
