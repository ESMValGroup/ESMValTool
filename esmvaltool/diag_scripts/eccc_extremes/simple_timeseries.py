...
def plot_timeseries(data_dic: dict, reference_dic: dict, cfg: dict,
    ...
    for dataset in data_dic.keys():
        ...
        variable = cfg['var_label'] if cfg.get(
            'var_label') else var_cb.var_name
        ...
        fig_path = os.path.join(cfg['plot_dir'],
                                f'timeseries_{variable}_{region}_{dataset}')
