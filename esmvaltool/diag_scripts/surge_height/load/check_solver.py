...
def check_solver(eof_inpath):
    ...
    glat_solver = os.path.join(eof_inpath, 
    ...
    if (os.path.exists(psl_solver) and os.path.exists(glat_solver) and
      os.path.exists(glon_solver) and os.path.exists(uas_solver) and
      os.path.exists(vas_solver)):
        for file in [psl_solver, glat_solver, 
               glon_solver, uas_solver, vas_solver 
               ]:
            try:
