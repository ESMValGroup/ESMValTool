...
def _extract_variable(var, cmor_table, attrs, filepath, out_dir):
    """Extract variable."""
    cmor_info = cmor_table.get_variable(var, var)

    with netCDF4.Dataset(filepath, 'r') as dataset:
        cube = _build_cube(dataset)
...
def cmorization(in_dir, out_dir, cfg, cfg_user, start_date, end_date):
    ...
    for var, var_info in cfg['variables'].items():
        ...
        _extract_variable(var, cmor_table, glob_attrs, filepath, out_dir)
