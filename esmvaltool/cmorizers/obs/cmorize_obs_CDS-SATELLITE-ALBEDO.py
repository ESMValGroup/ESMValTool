...
#    - see script cmorize_obs_CDS-SATELLITE-ALBEDO_with_gdal.py
#
# Last access
#    20190311
#
...
#    - Specify RAWFILENAMES in this script as the output from cmorize_obs_CDS-SATELLITE-ALBEDO_with_gdal.py
#
# Caveats
#    - This dataset is at 1-km  resolution originally, therefore a first preprocessing step
#      is taken outside ESMValTool (cmorize_obs_CDS-SATELLITE-ALBEDO_with_gdal.py) making use of gdalwarp to regrid from 1 km to 0.25 deg resolution
#
...
from .utilities import (add_metadata, convert_timeunits, fix_coords,
                        read_cmor_config, roll_cube_data, save_variable)
logger = logging.getLogger(__name__)

# Set these parameters
ALL_VARS = ['bdalb']
yr_start, yr_end = '1999', '2013'
