...
def download_cds_satellite_soil_moisture():
    ...
    for year in range(1978,2019):    
        ...
        'type_of_record': 'cdr',
        'version': 'v201812.0.0',        }
        client.retrieve('satellite-soil-moisture', request_dictionary, savename)
    # Unpack the file
    ...
    # Now ICDR v201812.0.1 (identical to v201812.0.0 according to data provider except for dates covered)
    savename = os.path.join(
    savedir,
    ...
    # Now ICDR v201812.0.0 (identical to v201812.0.1 according to data provider except for dates covered)
    savename = os.path.join(
    savedir,
