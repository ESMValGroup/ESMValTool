...
def get_recipe_provenance(documentation):
    ...
    recipe = doc.entity(
        'evt:recipe', {
            'evt:description': documentation['description'],
            'evt:projects': ', '.join(documentation['projects']),
            'evt:references': ', '.join(documentation['references']),
        })
            ...
            for output_file in all_input:
                ...
                if step == 'multi_model_statistics':
                    for filename in settings['filenames'].values():
                        output_entities.append(doc.entity('evt:' + filename))
                else:
                    output_entities.append(doc.entity('evt:' + output_file))
...
#                            })  # c is a collection, with unkdatetime.nown content
#     doc.hadMember(datasets, dataset1)
#     doc.hadMember(datasets, dataset2)
#     doc.hadMember(datasets, dataset3)
#     doc.hadMember(datasets, obs1)
#
#     infile11 = doc.entity('evt:infile11.nc', {'evt:trackingID': 'TrackingID'})
#     infile12 = doc.entity('evt:infile12.nc', {'evt:trackingID': 'TrackingID'})
#     infile13 = doc.entity('evt:infile13.nc', {'evt:trackingID': 'TrackingID'})
#     infile2 = doc.entity('evt:infile2.nc', {'evt:trackingID': 'TrackingID'})
#     infile3 = doc.entity('evt:infile3.nc', {'evt:trackingID': 'TrackingID'})
#     infile4 = doc.entity('evt:infile4.nc', {'evt:trackingID': 'TrackingID'})
