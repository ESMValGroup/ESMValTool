...
# Entity: 
outfile     = d1.entity('evt:outfile.png',{'evt:caption': 'Caption of the Image',
                                           'evt:variable': 'Variable',
                                           'evt:plottype': 'Plottype',
                                           'evt:domain': 'Domain',
                                           'evt:theme': 'Theme',
                                           'evt:realm': 'Realm'})
diagnostic  = d1.entity('evt:diagnostic', {'evt:description': 'Diag description',
                                              'evt:references': 'Reference',
                                              'evt:statistics': 'Statistics'})
recipe    = d1.entity('evt:recipe', {'evt:description': 'Nml description',
                                            'evt:project': 'Project', 
                                            'evt:references': 'Reference'})
...
datasets = d1.entity('evt:datasets', {'prov:type': 'prov:Collection'})      # c is a collection, with unknown content
...
software    = d1.entity('evt:software', {'evt:ESMValTool': 'v2.0.0a',
                                         'evt:Python': '3.5',
                                         'evt:NCL': '6.2.1'})
preproc_set = d1.entity('evt:preproc_setting',  {'evt:derivation': 'Derivation',
                                             'evt:timesel': 'Timesel',
                                             'evt:cmor': 'CMOR_fixes',
