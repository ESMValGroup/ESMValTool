...
class Fix(object):
    ...
    def get_fixes(project, model, variable):
        ...
        It will look for them at the module orchestrator.interface_scripts.fixes.PROJECT in the file MODEL, and get
        ...
        fixes = []
        try:
            fixes_module = importlib.import_module('orchestrator.interface_scripts.fixes.{0}.{1}'.format(project,
                                                                                                         model))
