...
for idx in $(seq 0 $((${#vars[@]}-1)));do
    mv -f ${outpath}/${vars[$idx]}_3hr_CERES-SYN1deg-3H-computed_r1i1p1_${yrs}.nc ${outpath}/${vars[$idx]}_3hr_CERES-SYN1deg_observation_r1i1p1_${yrs}.nc
#    mv -f ${outpath}/${vars[$idx]}_3hr_CERES-SYN1deg-3H-computed_r1i1p1_${yrs}.nc $outpath/OBS_CERES-SYN1deg-3H-computed_obs_1_T2Is_${vars[$idx]}.nc
